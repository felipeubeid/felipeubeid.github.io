  ...
  const projects: Project[] = [
    {
      ...
      description:
        "Created in my COP4870 course. Implements a full-stack inventory management system for a marketplace, featuring full CRUD operations and search on inventory and shopping cart, plus a checkout system.",
    ...
    },
    {
      ...
      description:
        "Developed a full-stack restaurant management application featuring CRUD functionality across finances, orders, menu, staff, and inventory modules.",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <div
                className="bg-card rounded-2xl p-6 h-full border border-border 
